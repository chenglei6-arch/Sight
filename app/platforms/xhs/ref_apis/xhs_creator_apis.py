...
from ref_utils.http_util import REQUEST_TIMEOUT
from ref_xhs_core.http import ordered_wire_headers
from ref_xhs_creator import XHSCreatorAuth
from ref_xhs_creator.http import CREATOR_ACCEPT_ENCODING
from ref_xhs_creator.params import (
    build_creator_business_headers,
    generate_request_params,
    splice_str,
)
from ref_xhs_creator_util import (
    get_fileIds_params,
    get_loc_data,
...
from ref_xhs_pc.params import generate_x_rap_param
