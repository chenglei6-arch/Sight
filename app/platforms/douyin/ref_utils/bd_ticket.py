...
def fetch_server_cert(aid, cookie_str, origin="https://www.douyin.com",
    ...
    from app.platforms.douyin.ref_utils.dy_util import generate_a_bogus, generate_msToken
    ...
    if csrf_token is None:
        ...
        try:
            from app.platforms.douyin.ref_utils.dy_util import generate_csrf_token
