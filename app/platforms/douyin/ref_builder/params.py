...
from app.platforms.douyin.ref_utils.dy_util import generate_webid, generate_msToken, splice_url, generate_a_bogus, generate_fake_webid
...
class Params:
    ...
    def signed_url(self, base_url, auth=None, ts=None):
        ...
        """
        from app.platforms.douyin.ref_utils.secsdk_web_sign import sign_url
        uifid = (auth.cookie or {}).get('UIFID', '') if auth else ''
