...
from app.platforms.douyin.ref_utils.dy_util import generate_ree_key, generate_bd_ticket_client_data, generate_csrf_token
...
class Header:
    ...
    def with_bd(self, api, auth, aid=6383, origin='https://www.douyin.com',
        ...
        """
        from app.platforms.douyin.ref_utils.bd_ticket import ticket_guard_version
